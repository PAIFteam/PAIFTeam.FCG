...
{
    public class GetGameByUIdQueryValidator : AbstractValidator<GetGameByUIdQuery>
    {
        public GetGameByUIdQueryValidator(IGameReadOnlyRepository gameReadOnlyRepository)
        {
            RuleFor(x => x.GameUId)
