...
{
    public class AttachGameUserCommand : Command
    {
    ...
    public class AttachGameUserCommandHandler : CommandHandler, IRequestHandler<AttachGameUserCommand, bool>
    {
        ...
        public AttachGameUserCommandHandler(IMediatorHandler mediator,
        ...
        public async Task<bool> Handle(AttachGameUserCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                await _gameUserRepository.Create(userGame, cancellationToken);
            ...
            {
                await _notifications.Handle(new DomainNotification("Game", $"Falha ao vincular jogo ao usuário: {ex.Message}"), cancellationToken);
                return false;
            }
        }
    }
