...
{
    public class AttachRoleUserCommandValidator : AbstractValidator<AttachRoleUserCommand>
    {

        public AttachRoleUserCommandValidator(UserManager<IdentityUserCustom> userManager, RoleManager<IdentityRoleCustom> roleManager)
        {
